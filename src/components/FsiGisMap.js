...
// ─── DEFAULT COLORS ───
const BRAND_COLOR = { color: '#9333ea', bg: '#e9d5ff', label: 'FSI' }; // Purple
...
function createClusterIcon(cluster) {
    ...
    let size = 36, fontSize = 12, bgColor = '#9333ea', shadowSize = '8px';

    if (count >= 100) { size = 48; fontSize = 14; bgColor = '#7e22ce'; shadowSize = '12px'; }
    else if (count >= 50) { size = 44; fontSize = 13; bgColor = '#9333ea'; shadowSize = '10px'; }
    else if (count >= 10) { size = 40; fontSize = 12; bgColor = '#a855f7'; shadowSize = '9px'; }
...
export default function FsiGisMap({ sites, onSiteClick, searchCoord, nearestSiteIds }) {
                    ...
                    <Popup maxWidth={300} minWidth={240}>
                        <div style={{ fontFamily: "'Inter', system-ui, sans-serif", padding: '2px' }}>
                            ...
                            <div style={{
                                ...
                                <InfoRow label="Provider" value="FSI" color={BRAND_COLOR.color} />
                                <InfoRow label="STO" value={site.sto} />
                                <InfoRow label="Ring" value={site.ring} />
                            </div>
