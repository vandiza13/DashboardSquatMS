...
export default function MtelSiteDetailModal({ isOpen, onClose, site }) {
                ...
                <div className="px-6 py-4 border-b border-[var(--border-color)] flex justify-between items-center bg-[var(--bg-surface-2)]">
                    <div>
                        <div className="flex items-center gap-2">
                            <span className="bg-red-600 text-white font-extrabold text-[10px] px-2 py-0.5 rounded uppercase">MTEL SITE</span>
                        </div>
