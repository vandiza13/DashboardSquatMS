...
// ─── DEFAULT COLORS ───
const BRAND_COLOR = { color: '#f97316', bg: '#fed7aa', label: 'UMT' }; // Orange
...
function createClusterIcon(cluster) {
    ...
    let size = 36, fontSize = 12, bgColor = '#f97316', shadowSize = '8px';

    if (count >= 100) { size = 48; fontSize = 14; bgColor = '#c2410c'; shadowSize = '12px'; }
    else if (count >= 50) { size = 44; fontSize = 13; bgColor = '#ea580c'; shadowSize = '10px'; }
    else if (count >= 10) { size = 40; fontSize = 12; bgColor = '#f97316'; shadowSize = '9px'; }
...
export default function UmtGisMap({ sites, onSiteClick, searchCoord, nearestSiteIds }) {
                    ...
                    <Popup maxWidth={300} minWidth={240}>
                        <div style={{ fontFamily: "'Inter', system-ui, sans-serif", padding: '2px' }}>
                            ...
                            <div style={{
                                ...
                                <InfoRow label="Provider" value="UMT" color={BRAND_COLOR.color} />
