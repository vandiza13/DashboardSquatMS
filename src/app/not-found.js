    ...
    <div className="min-h-screen flex items-center justify-center bg-[var(--bg-base)] p-4">
      <div className="text-center max-w-lg">
        ...
        <div className="relative inline-block mb-6">
          <div className="absolute inset-0 bg-yellow-200 dark:bg-yellow-500 rounded-full animate-ping opacity-20"></div>
          <div className="relative bg-[var(--bg-surface)] p-6 rounded-full shadow-xl">
        ...
        <h2 className="text-xl font-bold text-[var(--text-secondary)] mb-4">Halaman Tidak Ditemukan</h2>
