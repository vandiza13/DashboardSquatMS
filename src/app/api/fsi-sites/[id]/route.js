...
export async function GET(request, props) {
    ...
    try {
        ...
        const result = await pgPool.query('SELECT * FROM public.fsi_sites WHERE id = $1', [id]);
        ...
        console.error("GET FSI Site Detail Error:", error);
        return NextResponse.json({ error: 'Database Error' }, { status: 500 });
    }
}

// PUT: Perbarui data Site FSI
export async function PUT(request, props) {
    ...
    try {
        ...
        try {
            await appendSiteToSheet(updatedSite, 'FSI');
        } catch (sheetError) {
        ...
        console.error("Update FSI Site Error:", error);
        if (error.code === '23505') {
...
// DELETE: Hapus data Site FSI secara permanen
export async function DELETE(request, props) {
    ...
    try {
        ...
        const result = await pgPool.query('DELETE FROM public.fsi_sites WHERE id = $1 RETURNING *', [id]);
        ...
        console.error("DELETE FSI Site Error:", error);
